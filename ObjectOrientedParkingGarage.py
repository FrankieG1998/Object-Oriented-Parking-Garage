class Garage():
    ...
    def payForParking(self):
        ...
        if ticket_number in self.currentTicket:
            if paid != '':
                ...
                print("That ticket hasn't been distributed today.")
                return -1
        else:
    ...
    def leaveGarage(self):
        ...
        if ticket_number == -1:
            ...
            return -1
        input("Your ticket has been paid. You have 15 minutes to leave.")
    ...
    def run(self):
        while True:
            print("\n" + self.showSpots())
            response = input("Do you want to park, pay, leave, or quit? ")
